...
global lstm_recall,cnn_recall,svm_recall,knn_recall,random_recall,nb_recall
...
testButton = Button(main, text="TEST NN BUTTON", command=neuralNetwork, bg="red", fg="white")
testButton.place(x=50,y=80)
testButton.lift()
